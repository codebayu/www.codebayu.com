...
export default function ChatRoom({ user }: ChatRoomProps) {
  ...
  return (
    <div>
      <div
        ref={chatListRef}
        className="no-scrollbar 3xl:h-[75dvh] mb-4 h-[60vh] space-y-4 overflow-y-auto scroll-smooth border-b border-neutral-200 pb-2 dark:border-neutral-700 md:h-[65vh]"
      >
        {loading ? (
          <ChatItemSkeleton />
        ) : (
