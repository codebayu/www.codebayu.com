  ...
  return (
    <div className="flex w-full cursor-pointer flex-col text-start" onClick={handleCardClick}>
      ...
      <article className="mt-4 flex w-full flex-grow flex-col space-y-3 self-center">
        <h2 className="3xl:text-3xl  font-medium text-neutral-600 transition-all duration-300 dark:text-neutral-200 dark:hover:text-teal-400 md:text-[17px] lg:hover:text-teal-800">
          {trimmedTitle}
        </h2>
        <div className="flex gap-4 text-neutral-600 dark:text-neutral-400">
          <div className="flex items-center gap-1 ">
            <span className="3xl:text-base text-xs">{formatDate(published_at, 'MMM dd, yyyy')}</span>
          </div>
          <div className="flex items-center gap-1">
            <CommentIcon size={16} />
        ...
        <p className="3xl:text-lg hidden text-sm leading-relaxed text-neutral-600 dark:text-neutral-400 sm:block">
          {trimmedContent}
        </p>
      </article>
    </div>
