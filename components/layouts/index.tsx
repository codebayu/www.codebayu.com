  ...
  return (
    <div className="flex h-full w-full flex-col justify-center overflow-x-hidden">
      ...
      <div className="flex w-full flex-col justify-center lg:flex-row lg:gap-5">
        ...
        <div className="absolute inset-0 h-full w-full bg-[linear-gradient(to_right,#80808012_1px,transparent_1px),linear-gradient(to_bottom,#80808012_1px,transparent_1px)] bg-[size:30px_30px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_0%,#000_80%,transparent_100%)]"></div>
      </div>
