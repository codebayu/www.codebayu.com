  ...
  return (
    <ReactMarkdown
      ...
      components={{
        ...
        blockquote: props => (
          <blockquote
            className="pl-6 py-3 text-md border-l-[5px] border-neutral-700 border-l-cyan-500 bg-neutral-200 dark:bg-neutral-800 rounded-br-2xl text-cyan-800 dark:text-cyan-200"
            {...props}
          />
        ),
