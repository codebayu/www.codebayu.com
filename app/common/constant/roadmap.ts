const FRONTEND = [
  ...
  },
  {
    ...
    icon: 'CSS',
    linkIndonesia:
      'https://www.youtube.com/watch?v=J0a6YUUAsd4&list=PLFIM0718LjIVCmrSWbZPKCccCkfFw-Naa',
    linkEnglish: '',
  },
  {
    title: 'Bootstrap',
    icon: 'Bootstrap',
    linkIndonesia:
      'https://www.youtube.com/watch?v=NNW7Tg8CgAQ&list=PLFIM0718LjIVWpIhlNA_sU-4ZWvN4uSmb',
    linkEnglish: '',
  },
  {
    title: 'Flexbox CSS',
