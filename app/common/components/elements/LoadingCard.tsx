...
export default function LoadingCard({ view }: { view: string }) {
  ...
  return (
    <div
      className={clsxm(
        'w-full flex dark:bg-neutral-800 rounded-xl overflow-hidden',
    ...
    >
      ...
      <div className="flex flex-col flex-1 space-y-6 p-7">
        <div className="h-4 animate-pulse bg-neutral-700 rounded"></div>
        <div className="flex space-x-4">
          <div
            className={clsxm(
              'h-2 animate-pulse bg-neutral-700 rounded',
        ...
        <div className="flex flex-col space-y-3">
          <div className="h-2 w-full animate-pulse bg-neutral-700 rounded"></div>
          <div className="h-2 w-full animate-pulse bg-neutral-700 rounded"></div>
          <div className="h-2 w-full animate-pulse bg-neutral-700 rounded"></div>
        </div>
      </div>
